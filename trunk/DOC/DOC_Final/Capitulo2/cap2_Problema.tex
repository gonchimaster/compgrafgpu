...
En el algoritmo original de \emph{ray tracing}, además de considerar las fuentes de luz para obtener sombras en la escena, el algoritmo de trazado de rayos recursivo de Whitted genera rayos de reflexión y de refracción\footnote{Ver glosario.} desde el punto de intersección, como se muestra en la Figura~\ref{fig:exampleRT}.
