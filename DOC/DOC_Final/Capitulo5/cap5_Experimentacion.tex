...
Las características de los equipos utilizados para ejecutar los casos de prueba se muestran en la Tabla \ref{table:EquiposUtilizados}. Todos los equipos utilizados usan \emph{Windows} como sistema operativo, a excepción del equipo 9800 que utiliza \emph{Linux}.

%%%% Falta agregar la plataforma linux y detalles de la tarjeta gráfica...
...
%%%%% se podría incluir una grafica para visualizar mejor los datos
