...
El pre-proceso consiste en dividir el volumen total de la escena en pequeños volúmenes o cajas. La forma de definir estas cajas es lo que marca la diferencia entre las técnicas de sub-división espacial. Una vez que las cajas están definidas juegan el mismo papel en todas ellas.
...
\begin{itemize}
  ...
  \item para escenas estáticas, el orden del algoritmo de generación de cada cuadro de una animación es sub-lineal en la cantidad de objetos básicos en la escena.
